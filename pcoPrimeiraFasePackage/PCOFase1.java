...
public class PCOFase1 {
	...
	/**
	 * Aqui invoca-se a funcao evolucao da classe MetodosEvolucao para varios
	 * valores dos seus parametros e imprimem-se os resultados no standard output
	 * 
	...
	public static void main(String[] args) {
		...
		/*
		 * Exemplo 1 Copia do output no ficheiro output1.txt
		 */
		char[][] terra1 = { { '.', 'x', '.', '.', '.', '.', '.', 'x', '.', '.' },
				{ '.', '.', '.', '*', '.', '.', 'x', '*', '.', '*' },
				{ '.', '.', '.', 'x', '.', '.', '*', '.', 'x', '.' },
		...
		/*
		 * Exemplo 2 Copia do output no ficheiro output2.txt
		 */
		char[][] terra2 = {
				{ '.', 'x', '.', '.', '.', '.', '.', '*', '.', '.', '.', '.', '.', '.', '*', '.', '.', '.' },
				{ 'x', 'x', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.', '.' },
		...
		/*
		 * Exemplo 3 Copia do output no ficheiro output3.txt
		 */
		char[][] terra3 = { { '.', '.', '.', '.', '.', '*' }, { '.', '.', '.', '.', 'x', '.' },
				{ '.', '.', '.', 'x', '.', '.' }, { '.', '.', 'x', '.', '.', '.' }, { '.', 'x', '.', '.', '.', '.' },
				{ '*', '.', '.', '.', '.', '.' } };
		...
		/*
		 * Exemplo 4 Copia do output no ficheiro output4.txt
		 */
		char[][] terra4 = { { '.', '.', 'x', '*', 'x', '.' }, { '*', '.', '.', 'x', '.', '.' },
				{ '.', '.', 'x', '*', 'x', '.' }, { '.', '.', '.', 'x', '.', '.' }, { 'x', '.', '.', '.', '.', '.' },
				{ '*', 'x', '.', '.', '.', '.' } };
		...
		/*
		 * Exemplo 5 Copia do output no ficheiro output5.txt
		 */
		char[][] terra5 = { { '*', 'x', '*' }, { 'x', '.', 'x' }, { '*', 'x', '*' }, };
